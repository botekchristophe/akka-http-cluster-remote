...
import com.inocybe.pfm.template.model.{Work, WorkResult}
...
object MasterActor {
  ...
  def props(workTimeout: FiniteDuration): Props =
    Props(classOf[MasterActor], workTimeout)
...
class MasterActor(workTimeout: FiniteDuration) extends PersistentActor with ActorLogging {
